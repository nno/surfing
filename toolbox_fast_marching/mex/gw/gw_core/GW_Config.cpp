...
void GW::GW_OutputComment( const char* str )
{
	if( GW_OutputStream!=NULL )
	{
        ...
        //The line below (which was the original) is considered unsafe
        //when compiling under Ubuntu with default options.
        //Instead, fputs is used.
        //
		//fprintf( GW_OutputStream, str2.c_str() );
        fputs(str2.c_str(), GW_OutputStream);
	}
}
